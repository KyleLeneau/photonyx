...
/// supplied, **-hsl**, **-hsv** or **-lab** to perform an HSL, HSV or CieLAB extraction.
/// If no option is provided, the extraction is of RGB type, meaning no conversion is done.
#[derive(Builder)]
pub struct Split {
    #[builder(start_fn)]
    file1: String,
