...
fn commit_info(workspace_root: &Path) {
    ...
    println!("cargo:rustc-env={}={}", EnvVars::PX_COMMIT_HASH, next());
    println!(
        "cargo:rustc-env={}={}",
        EnvVars::PX_COMMIT_SHORT_HASH,
        next()
    );
    println!("cargo:rustc-env={}={}", EnvVars::PX_COMMIT_DATE, next());
